...
### Read data
dat=fread("input/hg002_benchmark_all.txt", header = T, sep = "\t", na.strings = "NA")
head(dat)
...
p
ggsave(file = "output/hg002_benchmark.pdf", p, width = 110, height = 38, units = "mm", device=cairo_pdf)
