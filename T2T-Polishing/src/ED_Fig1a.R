...
dat1=fread("input/ED_Fig1/ED_Fig1a_illumina.0.hifi.meryl.GA_TC.hist", header=F)
dat1$LogCount=log(dat1$V3, base = 10)
summary(dat1)

dat2=fread("input/ED_Fig1/ED_Fig1a_hifi.0.illm.meryl.GA_TC.hist", header=F)
...
ggsave(paste("output/ED_Fig1a.jpg", sep=""), width = 5, height = 1.8)
