...
dat=fread("input/ED_Fig1/ED_Fig1b-d_missing_kmers.tab", header = T)
head(dat)
...
ggsave("output/ED_Fig1b_missing_kmer_hifi.jpg", width = 3.5, height = 1.7)

plot_bars(dat = dat_illm, title = "k-mers missing in Illumina", palette = illmPalette)
ggsave("output/ED_Fig1c_missing_kmer_illumina.jpg", width = 3.5, height = 1.7)

plot_bars(dat = dat_hybr, title = "k-mers missing in Hybrid", palette = hybrPalette)
ggsave("output/ED_Fig1d_missing_kmer_hybrid.jpg", width = 3.5, height = 1.7)
