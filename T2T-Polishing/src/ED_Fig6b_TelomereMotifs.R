...
dat = read.table("input/chm13v1.1.perfect.lens")
new=data.frame(idy=dat[,1])
new$Assembly="CHM13v1.1"
dat = read.table("input/chm13v1.0.perfect.lens")
old=data.frame(idy=dat[,1])
old$Assembly="CHM13v1.0"
vegLengths=rbind(old, new)

pdf("output/ED_Fig6b.pdf", width=160, height=60, units("mm"), pointsize=6, useDingbats=F)
...
ggsave("output/ED_Fig6b.jpg", width=160, height=60, units = "mm")
