...
### Get genomes order
#genomes=fread("input/Fig2/genome.list.srt", header = F)
...
# Prepare 10X data
#dat.10x=fread("input/Fig2/linked.len", header=T)
...
#dat_all = fread("input/Fig2/fGouWil2.1kb.weighted", header=F, nThread=4)
...
# Plot density
pdf("Fig2_readlen_wt.h10.pdf", width=5, height=10, pointsize=12, useDingbats=F)
