...
iNAME_sID = paste0("input/Fig7a/",RefID,"/sID_list.txt")
...
fNAME = paste0("input/Fig7a/",RefID,"/dnaseg/dnaseg_",sID,'.txt')
...
fNAME = paste0("input/Fig7a/",RefID,"/annotation/annotation_",sID,'.txt')
data = read.table(fNAME,sep="\t",header=T)
...
fNAME = paste0("input/Fig7a/",RefID,"/comparison/comparison",compNumb,'.txt')
data = read.table(fNAME,sep="\t",header=T)
